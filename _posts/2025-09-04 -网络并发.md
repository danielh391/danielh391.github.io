...
**结论**：单纯的非阻塞 I/O 避免了线程阻塞，但引入了昂贵的轮询开销。我们需要一种更高效的方法来知道“哪个 socket 准备好了”。阻塞read和非阻塞read的核心区别：在于阻塞read在socket内核缓冲区没数据时会一直阻塞，而非阻塞
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM3NzIxMzA0OCwyMDM1MzQ5NDQ5LC0yOD
g2MDYwMzBdfQ==
-->